...
export const postEditSaveSelector = '[data-e2e-element=save]';
export const postEditTitleSelector = '[data-e2e-element=title]';
export const postEditNameSelector = '[data-e2e-element=post-name]';
export const postEditAgeSelector = '[data-e2e-element=post-age]';
...
export const postDeleteConfirmSelector = '[data-e2e-element=confirm]';
export const postDeleteTitleSelector = '[data-e2e-element=title]';
